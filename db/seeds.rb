...
Product.create(name: "Potted Plant", description: "A nice plant", price: "15.00", user_id: 1, available: 1)
Product.create(name: "Hose 75ft", description: "A long hose", price: "34.99", user_id: 2, available: 1)
Product.create(name: "Metal Plate", description: "A metal plate of unknown uses", price: "19.99", user_id: 3, available: 1)
Product.create(name: "SSD 500gb", description: "This unknown brand SSD stores data", price: "79.99", user_id: 4, available: 1)
Product.create(name: "Rare Cd", description: "A hard to find cd", price: "119.99", user_id: 5, available: 0)
